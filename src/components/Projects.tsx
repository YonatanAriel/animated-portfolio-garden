  ...
  const projects = [
    {
      title: "UniverChat",
      description:
        "Chat app with automatic message translation using TypeScript, SQLite, Socket.io and Git",
    ...
    },
    {
      title: "Music App",
      description:
        "A music application leveraging asynchronous programming with React.js, Node.js, Express, and MongoDB",
    ...
    },
    {
      title: "DevFolio",
      description:
        "Platform showcasing developer projects, built with Next.js, Tailwind CSS, MongoDB and Vite",
